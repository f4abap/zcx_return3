...
CLASS zcx_return3 IMPLEMENTATION.
  ...
  METHOD add_bapiret1_struc.
    DATA: ls_bapiret2_struc Type BAPIRET2.

    ls_bapiret2_struc = map_bapiret1_to_bapiret2( is_return ).
  ...
  METHOD add_bapiret1_table.
    ...
    field-symbols <ls_return> Type BAPIRET1.
    LOOP AT it_return
      ASSIGNING <ls_return>.
...
field-symbols <ls_return> Type BAPIRETURN.
    LOOP AT it_return
      ASSIGNING <ls_return>.
  ...
  METHOD add_bdc_table.
    ...
    field-symbols <ls_bdc_message>          TYPE bdcmsgcoll.
    field-symbols <ls_bapiret2>          TYPE BAPIRET2.

    LOOP AT it_bdc_messages
      ASSIGNING <ls_bdc_message>.
  ...
  METHOD add_exception_object.
    ...
    lv_text = ir_exception_object->get_text( ).
...
DATA ls_bapiret2          TYPE bapiret2.
  ...
  METHOD add_text.
    ...
    DO 4 TIMES.
      ...
      field-symbols <lv_variable> type any.
      field-symbols <lv_return_variable> type any.
...
*    ENDIF.
  ...
  METHOD get_bapiret2_table.
    ...
    IF gt_return[] IS INITIAL.
      ...
      ls_bapiret2 = get_bapiret2_struc( ).
  ...
  METHOD if_message~get_text.
    ...
    ls_return = me->get_bapiret2_struc( ).
  ...
  METHOD map_text_var_to_bapiret2.
    ...
    DATA:
      ...
      ls_text        TYPE ltv_variable.
    field-symbols <ls_variable> type ltv_variable.
    ...
    LOOP AT lt_text ASSIGNING <ls_variable>.
